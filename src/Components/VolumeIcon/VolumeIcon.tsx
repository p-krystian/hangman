...
function VolumeIcon() {
  ...
  return (
    <svg
      ...
      height="100%"
      strokeLinecap="round"
      aria-label={l('volumeWord')}
      name={l('volumeWord')}
    >
      <title>{l('volumeWord')}</title>
      <path
        fill="currentColor"
        d="M 7.7,0 C 7.5,0 7.3,0 7.1,0.2 L 3.3,4.4 H 0.5 C 0.2,4.4 2.8e-5,4.6 0,4.9 v 6.9 c 2.8e-5,0.3 0.2,0.5 0.5,0.5 h 2.8 l 3.9,3.6 C 7.5,16.2 8,15.9 8,15.5 V 0.5 C 8,0.3 7.9,0.1 7.7,0 Z"
      />
      {volume === 0 ? (
        <>
